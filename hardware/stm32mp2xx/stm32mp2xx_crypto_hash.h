...
#ifndef _STM32MP2XX_CRYPTO_HASH_H
#define _STM32MP2XX_CRYPTO_HASH_H

//Dependencies
#include "core/crypto.h"

//Hash hardware accelerator
#ifndef STM32MP2XX_CRYPTO_HASH_SUPPORT
   #define STM32MP2XX_CRYPTO_HASH_SUPPORT DISABLED
#elif (STM32MP2XX_CRYPTO_HASH_SUPPORT != ENABLED && STM32MP2XX_CRYPTO_HASH_SUPPORT != DISABLED)
   #error STM32MP2XX_CRYPTO_HASH_SUPPORT parameter is not valid
#endif
