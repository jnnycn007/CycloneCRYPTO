/**
 * @file pic32cz_ca90_crypto_hash.h
...
#ifndef _PIC32CZ_CA90_CRYPTO_HASH_H
#define _PIC32CZ_CA90_CRYPTO_HASH_H

//Dependencies
#include "core/crypto.h"

//Hash hardware accelerator
#ifndef PIC32CZ_CA90_CRYPTO_HASH_SUPPORT
   #define PIC32CZ_CA90_CRYPTO_HASH_SUPPORT DISABLED
#elif (PIC32CZ_CA90_CRYPTO_HASH_SUPPORT != ENABLED && PIC32CZ_CA90_CRYPTO_HASH_SUPPORT != DISABLED)
   #error PIC32CZ_CA90_CRYPTO_HASH_SUPPORT parameter is not valid
#endif

//Data buffer size
#ifndef PIC32CZ_CA90_ICM_BUFFER_SIZE
   #define PIC32CZ_CA90_ICM_BUFFER_SIZE 1024
#elif (PIC32CZ_CA90_ICM_BUFFER_SIZE < 64)
   #error PIC32CZ_CA90_ICM_BUFFER_SIZE parameter is not valid
#endif

//Name of the section where to place DMA buffers
#ifndef PIC32CZ_CA90_ICM_RAM_SECTION
   #define PIC32CZ_CA90_ICM_RAM_SECTION ".ram_no_cache"
#endif
