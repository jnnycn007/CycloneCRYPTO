   ...
   const uint32_t *b)
{
   ...
   if(r2 != NULL && m != 0)
   {
      ...
      for(i = 0; i < n; i++)
      {
         REG_WRITE(RSA_M_MEM + i * 4, curve->p[i]);
      }

      //Copy the pre-calculated value of R^2 mod M to RSA_Z_MEM
      for(i = 0; i < n; i++)
      {
         REG_WRITE(RSA_Z_MEM + i * 4, r2[i]);
      }
   ...
   const uint32_t *b)
{
   ...
   if(r2 != NULL && m != 0)
   {
      ...
      for(i = 0; i < n; i++)
      {
         REG_WRITE(RSA_M_MEM + i * 4, curve->q[i]);
      }
