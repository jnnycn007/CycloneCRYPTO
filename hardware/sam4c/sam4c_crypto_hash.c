...
//ICM region descriptor
static Sam4cIcmDesc icmDesc __attribute__((aligned(64)));
//ICM hash area
   ...
   uint32_t *h)
{
   ...
   ICM->ICM_CFG = ((algo << 13) & ICM_CFG_UALGO_Msk) | ICM_CFG_UIHASH | ICM_CFG_SLBDIS;
