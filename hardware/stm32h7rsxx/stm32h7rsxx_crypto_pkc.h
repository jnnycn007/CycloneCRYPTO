/**
 * @file stm32h7rsxx_crypto_pkc.h
 * @brief STM32H7Rx/Sx public-key hardware accelerator (PKA)
 *
 * @section License
 *
...
#ifndef _STM32H7RSXX_CRYPTO_PKC_H
#define _STM32H7RSXX_CRYPTO_PKC_H

//Dependencies
#include "core/crypto.h"

//Public-key hardware accelerator
#ifndef STM32H7RSXX_CRYPTO_PKC_SUPPORT
   #define STM32H7RSXX_CRYPTO_PKC_SUPPORT DISABLED
#elif (STM32H7RSXX_CRYPTO_PKC_SUPPORT != ENABLED && STM32H7RSXX_CRYPTO_PKC_SUPPORT != DISABLED)
   #error STM32H7RSXX_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
