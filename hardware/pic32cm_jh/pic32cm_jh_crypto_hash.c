...
static Pic32cmjhIcmDesc icmDesc;
//ICM hash area
...
//ICM region descriptor
static Pic32cmjhIcmDesc icmDesc __attribute__((aligned(64)));
//ICM hash area
   ...
   uint32_t *h)
{
   ...
   osAcquireMutex(&pic32cmjhCryptoMutex);
   ...
   osReleaseMutex(&pic32cmjhCryptoMutex);
}
