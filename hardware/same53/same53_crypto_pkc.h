/**
 * @file same53_crypto_pkc.h
 * @brief SAME53 public-key hardware accelerator (PUKCC)
 *
 * @section License
 *
...
#ifndef _SAME53_CRYPTO_PKC_H
#define _SAME53_CRYPTO_PKC_H

//Dependencies
#include "core/crypto.h"

//Public-key hardware accelerator
#ifndef SAME53_CRYPTO_PKC_SUPPORT
   #define SAME53_CRYPTO_PKC_SUPPORT DISABLED
#elif (SAME53_CRYPTO_PKC_SUPPORT != ENABLED && SAME53_CRYPTO_PKC_SUPPORT != DISABLED)
   #error SAME53_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
