/**
 * @file stm32g4xx_crypto_cipher.h
 * @brief STM32G4 cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32G4XX_CRYPTO_CIPHER_H
#define _STM32G4XX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32G4XX_CRYPTO_CIPHER_SUPPORT
   #define STM32G4XX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32G4XX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32G4XX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32G4XX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
