/**
 * @file stm32u3xx_crypto_pkc.h
 * @brief STM32U3 public-key hardware accelerator (PKA)
 *
 * @section License
 *
...
#ifndef _STM32U3XX_CRYPTO_PKC_H
#define _STM32U3XX_CRYPTO_PKC_H

//Dependencies
#include "core/crypto.h"

//Public-key hardware accelerator
#ifndef STM32U3XX_CRYPTO_PKC_SUPPORT
   #define STM32U3XX_CRYPTO_PKC_SUPPORT DISABLED
#elif (STM32U3XX_CRYPTO_PKC_SUPPORT != ENABLED && STM32U3XX_CRYPTO_PKC_SUPPORT != DISABLED)
   #error STM32U3XX_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
