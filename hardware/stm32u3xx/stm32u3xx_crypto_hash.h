/**
 * @file stm32u3xx_crypto_hash.h
 * @brief STM32U3 hash hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32U3XX_CRYPTO_HASH_H
#define _STM32U3XX_CRYPTO_HASH_H

//Dependencies
#include "core/crypto.h"

//Hash hardware accelerator
#ifndef STM32U3XX_CRYPTO_HASH_SUPPORT
   #define STM32U3XX_CRYPTO_HASH_SUPPORT DISABLED
#elif (STM32U3XX_CRYPTO_HASH_SUPPORT != ENABLED && STM32U3XX_CRYPTO_HASH_SUPPORT != DISABLED)
   #error STM32U3XX_CRYPTO_HASH_SUPPORT parameter is not valid
#endif
