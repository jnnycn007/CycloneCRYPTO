/**
 * @file stm32u3xx_crypto_cipher.h
 * @brief STM32U3 cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32U3XX_CRYPTO_CIPHER_H
#define _STM32U3XX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32U3XX_CRYPTO_CIPHER_SUPPORT
   #define STM32U3XX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32U3XX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32U3XX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32U3XX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
