/**
 * @file stm32h5xx_crypto_cipher.h
 * @brief STM32H5 cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32H5XX_CRYPTO_CIPHER_H
#define _STM32H5XX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32H5XX_CRYPTO_CIPHER_SUPPORT
   #define STM32H5XX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32H5XX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32H5XX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32H5XX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
