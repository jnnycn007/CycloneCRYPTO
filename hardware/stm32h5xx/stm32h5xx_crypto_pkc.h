/**
 * @file stm32h5xx_crypto_pkc.h
 * @brief STM32H5 public-key hardware accelerator (PKA)
 *
 * @section License
 *
...
#define _STM32H5XX_CRYPTO_PKC_H

//Dependencies
#include "core/crypto.h"

//Public-key hardware accelerator
#ifndef STM32H5XX_CRYPTO_PKC_SUPPORT
   #define STM32H5XX_CRYPTO_PKC_SUPPORT DISABLED
#elif (STM32H5XX_CRYPTO_PKC_SUPPORT != ENABLED && STM32H5XX_CRYPTO_PKC_SUPPORT != DISABLED)
   #error STM32H5XX_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
