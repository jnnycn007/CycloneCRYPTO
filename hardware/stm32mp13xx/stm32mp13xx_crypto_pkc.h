/**
 * @file stm32mp13xx_crypto_pkc.h
 * @brief STM32MP13 public-key hardware accelerator (PKA)
 *
 * @section License
 *
...
#ifndef _STM32MP13XX_CRYPTO_PKC_H
#define _STM32MP13XX_CRYPTO_PKC_H

//Dependencies
#include "core/crypto.h"

//Public-key hardware accelerator
#ifndef STM32MP13XX_CRYPTO_PKC_SUPPORT
   #define STM32MP13XX_CRYPTO_PKC_SUPPORT DISABLED
#elif (STM32MP13XX_CRYPTO_PKC_SUPPORT != ENABLED && STM32MP13XX_CRYPTO_PKC_SUPPORT != DISABLED)
   #error STM32MP13XX_CRYPTO_PKC_SUPPORT parameter is not valid
#endif
