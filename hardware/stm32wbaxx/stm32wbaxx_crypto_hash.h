/**
 * @file stm32wbaxx_crypto_hash.h
 * @brief STM32WBA hash hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32WBAXX_CRYPTO_HASH_H
#define _STM32WBAXX_CRYPTO_HASH_H

//Dependencies
#include "core/crypto.h"

//Hash hardware accelerator
#ifndef STM32WBAXX_CRYPTO_HASH_SUPPORT
   #define STM32WBAXX_CRYPTO_HASH_SUPPORT DISABLED
#elif (STM32WBAXX_CRYPTO_HASH_SUPPORT != ENABLED && STM32WBAXX_CRYPTO_HASH_SUPPORT != DISABLED)
   #error STM32WBAXX_CRYPTO_HASH_SUPPORT parameter is not valid
#endif
