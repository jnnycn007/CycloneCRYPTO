/**
 * @file stm32wbaxx_crypto_cipher.h
 * @brief STM32WBA cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32WBAXX_CRYPTO_CIPHER_H
#define _STM32WBAXX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32WBAXX_CRYPTO_CIPHER_SUPPORT
   #define STM32WBAXX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32WBAXX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32WBAXX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32WBAXX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
