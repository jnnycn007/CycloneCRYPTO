/**
 * @file stm32h7xx_crypto_hash.h
 * @brief STM32H7 hash hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32H7XX_CRYPTO_HASH_H
#define _STM32H7XX_CRYPTO_HASH_H

//Dependencies
#include "core/crypto.h"

//Hash hardware accelerator
#ifndef STM32H7XX_CRYPTO_HASH_SUPPORT
   #define STM32H7XX_CRYPTO_HASH_SUPPORT DISABLED
#elif (STM32H7XX_CRYPTO_HASH_SUPPORT != ENABLED && STM32H7XX_CRYPTO_HASH_SUPPORT != DISABLED)
   #error STM32H7XX_CRYPTO_HASH_SUPPORT parameter is not valid
#endif
