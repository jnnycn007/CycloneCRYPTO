/**
 * @file stm32wbxx_crypto_cipher.h
...
#ifndef _STM32WBXX_CRYPTO_CIPHER_H
#define _STM32WBXX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32WBXX_CRYPTO_CIPHER_SUPPORT
   #define STM32WBXX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32WBXX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32WBXX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32WBXX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
