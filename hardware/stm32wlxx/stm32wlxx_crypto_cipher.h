/**
 * @file stm32wlxx_crypto_cipher.h
 * @brief STM32WL cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32WLXX_CRYPTO_CIPHER_H
#define _STM32WLXX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32WLXX_CRYPTO_CIPHER_SUPPORT
   #define STM32WLXX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32WLXX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32WLXX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32WLXX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
