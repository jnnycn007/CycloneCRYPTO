/**
 * @file stm32u0xx_crypto_cipher.h
 * @brief STM32U0 cipher hardware accelerator
 *
 * @section License
 *
...
#ifndef _STM32U0XX_CRYPTO_CIPHER_H
#define _STM32U0XX_CRYPTO_CIPHER_H

//Dependencies
#include "core/crypto.h"

//Cipher hardware accelerator
#ifndef STM32U0XX_CRYPTO_CIPHER_SUPPORT
   #define STM32U0XX_CRYPTO_CIPHER_SUPPORT DISABLED
#elif (STM32U0XX_CRYPTO_CIPHER_SUPPORT != ENABLED && STM32U0XX_CRYPTO_CIPHER_SUPPORT != DISABLED)
   #error STM32U0XX_CRYPTO_CIPHER_SUPPORT parameter is not valid
#endif
